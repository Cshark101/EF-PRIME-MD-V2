...
module.exports = {
    ...
    run: async ({ sock, m, args }) => {
        ...
        try {
            const apiUrl = `https://kaiz-apis.gleeze.com/api/gemini-flash-2.0?q=${encodeURIComponent(question || 'Describe this image.')}&uid=${encodeURIComponent(m.sender.split('@')[0])}&imageUrl=${encodeURIComponent(imageUrl || '')}&key=8e3b0d39-d9d4-47a1-a125-0801eb103e7f`;
